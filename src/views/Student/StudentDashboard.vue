  ...
  <div class="container">
    ...
    <ul class="list-unstyled">
      <li v-for="session in filteredSessions" :key="session.id" class="mb-3">
        <div class="card shadow-sm cursor-pointer hover-effect"
          @click="goToCourse(session.courseGroupId, session.courseSessionId)">
          <div class="card-body">
...
const goToCourse = (groupId: number, courseId: number) => {
  router.push({ name: 'SelectedCourseStudent', params: { id: groupId, courseId: courseId } });
}
</script>
